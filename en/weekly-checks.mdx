...
Weekly checks, combined with regular [service intervals](/en/service-intervals), help prevent small issues from turning into major problems. This proactive approach keeps your scooter safe, reliable, and cost-effective to operate.

## Checklist

[x] Check tyre pressure and inspect for any puncture
[x] Inspect tyre tread depth and wear
[x] Test front and rear brake operation
- [x] Check brake fluid level (if applicable)
- [x] Test headlights, brake lights and indicators
- [x] Replace any blown bulbs
- [x] Check engine oil level and top up if needed
- [x] Inspect vehicle for oil leaks
- [x] Inspect chain or belt for wear or slack
- [x] Lubricate chain if required
[x] Check battery terminals and connections
