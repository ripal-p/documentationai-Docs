...
title: Flat tyre
description: >-
  Stay safe and know what to do if you get a flat tyre on a Motion Rental bike,
  including what we cover, your costs, and roadside assistance.
---
<ExpandableGroup>
...
<Steps>
  ...
  <Step title="Contact roadside assistance" icon="phone" title-type="p">
    Use the contact details on the [Roadside assistance](/en/roadside-assistance) page or in your booking confirmation to request help.
...
- **Use correct tyre size and rating** for your Motion Rental bike. Refer to the [Tyre size](/en/tyre-size) page for the exact specifications for your model.
...
<ExpandableGroup>
  ...
  <Expandable title="What if I get a flat tyre?" default-open="false">
  ...
  <Expandable title="What happens if I keep riding with a flat tyre?" default-open="false">
  ...
  <Expandable title="Will my insurance cover a flat tyre?" default-open="false">
    No. Flat tyres and punctures are considered normal wear and tear and are not covered under insurance.
  </Expandable>

  <Expandable title="Are front tyre punctures repairable?" default-open="false">
    Generally, no. Most Queensland repair centres do not repair front tyres due to safety concerns.
  </Expandable>

  <Expandable title="Can I repair the tyre myself?" default-open="false">
  ...
  <Expandable title="Will you help me if I am stranded with a flat tyre?" default-open="false">
...
<Columns cols="2">
  <Card title="Roadside assistance" href="/en/roadside-assistance" icon="shield-user" horizontal="true">
