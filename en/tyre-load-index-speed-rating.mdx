...
For more detail on tyre size markings, see [Tyre size](/en/tyre-size).
...
<Columns cols="2">
  ...
  <Card title="Weekly checks" href="/en/weekly-checks" icon="calendar-check" horizontal="true" target="_self">
