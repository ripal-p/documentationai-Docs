---
title: Tyre size
description: Understand scooter tyre size markings, choose safe sizes for 110–125cc scooters, and maintain tyres for grip, stability, and comfort.
---
...
- You notice visible structural damage
...
<ExpandableGroup>
  ...
  <Expandable title="How often should I check tyre pressure?">
    At least once per week and before any long ride.
  </Expandable>

  <Expandable title="Do front and rear tyres need to be the same size?">
  ...
  <Expandable title="Can I install wider tyres for better grip?">
  ...
  <Expandable title="Where can I find my vehicle’s tyre size?">
