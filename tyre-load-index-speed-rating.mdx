...
Cars and larger motorcycles often use higher ratings like **S (180)**, **T (190)**, **H (210)**, **V (240)** and above.
...
- If the manual or original tyre says **J (100 km/h)**, you can use **J, L, M, P, T, H, V**, etc.
...
<Columns cols="2">
  <Card title="Tyre size" href="/tyre-size" icon="circle" cta="Understand your tyre size markings" horizontal="true">

  </Card>

  <Card title="Weekly checks" href="/weekly-checks" icon="calendar-check" cta="See what to inspect on your scooter each week" horizontal="true">

  </Card>

  <Card title="Flat tyre" href="/flat-tyre" icon="loader-pinwheel" cta="What to do if you get a puncture" horizontal="true">
