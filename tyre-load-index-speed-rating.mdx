...
description: Understand what tyre load index and speed ratings mean, how they affect safety, and how to choose the right tyres for your Motion Rental scooter.
---
...
<Columns cols="2">
  <Card
    ...
    href="/tyre-size"
    icon="circle"
    cta="Understand your tyre size markings"
    horizontal="true"
  >
  </Card>
  ...
  <Card
    ...
    href="/weekly-checks"
    icon="calendar-check"
    cta="See what to inspect on your scooter each week"
    horizontal="true"
  >
  </Card>
  ...
  <Card
    ...
    cta="What to do if you get a puncture"
    horizontal="true"
  >
  </Card>
</Columns>
