...
<form>
    ...
    <ul style="list-style:none;padding:0;margin:0;">
      <li>
        <div>
          <label style="display:flex;flex-direction:row;justify-content:start;gap:1rem;align-items:center;">
            <input type="checkbox" />
            [CU] Check tyre pressure and inspect for any puncture
          </label>
        </div>
      </li>
      ...
      <li>
        <div>
          <label style="display:flex;flex-direction:row;justify-content:start;gap:1rem;align-items:center;">
            <input type="checkbox" />
            [MR] Inspect tyre tread depth and wear
          </label>
        </div>
      </li>
      ...
      <li>
        <div>
          <label style="display:flex;flex-direction:row;justify-content:start;gap:1rem;align-items:center;">
            <input type="checkbox" />
            [MR] Test front and rear brake operation
          </label>
        </div>
      </li>
      ...
      <li>
        <div>
          <label style="display:flex;flex-direction:row;justify-content:start;gap:1rem;align-items:center;">
            <input type="checkbox" />
            [MR] Check brake fluid level (if applicable)
          </label>
        </div>
      </li>
      ...
      <li>
        <div>
          <label style="display:flex;flex-direction:row;justify-content:start;gap:1rem;align-items:center;">
            <input type="checkbox" />
            [MR] Test headlights, brake lights and indicators
          </label>
        </div>
      </li>
      ...
      <li>
        <div>
          <label style="display:flex;flex-direction:row;justify-content:start;gap:1rem;align-items:center;">
            <input type="checkbox" />
            [MR] Check engine oil level and top up if needed
          </label>
        </div>
      </li>
      ...
      <li>
        <div>
          <label style="display:flex;flex-direction:row;justify-content:start;gap:1rem;align-items:center;">
            <input type="checkbox" />
            [MR] Inspect vehicle for oil leaks
          </label>
        </div>
      </li>
      ...
      <li>
        <div>
          <label style="display:flex;flex-direction:row;justify-content:start;gap:1rem;align-items:center;">
            <input type="checkbox" />
            [MR] Inspect chain or belt for wear or slack
          </label>
        </div>
      </li>
      ...
      <li>
        <div>
          <label style="display:flex;flex-direction:row;justify-content:start;gap:1rem;align-items:center;">
            <input type="checkbox" />
            [CU] Lubricate chain if required
          </label>
        </div>
      </li>
      ...
      <li>
        <div>
          <label style="display:flex;flex-direction:row;justify-content:start;gap:1rem;align-items:center;">
            <input type="checkbox" />
            [MR] Check battery terminals and connections
          </label>
        </div>
      </li>
    </ul>
  ...
  <div>
    ...
    <ul>
      <li><strong>CU</strong> — inspection &amp; repair or replacement cost is the renter’s responsibility</li>
      <li><strong>MR</strong> — inspection is rider’s responsibility, repair or replacement handled by the Motion Rental</li>
    </ul>
  </div>
</form>
