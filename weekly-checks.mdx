...
<form>
  <p>
    Complete this inspection atleast once per week for your rented vehicle.
  </p>
  ...
  <fieldset>
    ...
    <ul style="list-style: none; padding: 0, margin: 0;">
      <li>
        <div>
          <label style="display: flex; flex-direction: row; gap: 1em; justify-content: start; lign-items: center;">
            <input type="checkbox" />
