...
<form class="checklist">
  <p style="font-size: var(--text-l);color: var(--text-heading);">
  ...
  <fieldset>
    ...
    <ul class="ruled-grid" style="--_gap: var(--grid-gap);">
      <li>
        <div class="check-item">
          <label class="resp-user">
            <input type="checkbox" />
            Check tyre pressure and inspect for any puncture
          </label>
        </div>
      </li>
      ...
      <li>
        <div class="check-item">
          <label class="resp-company">
            <input type="checkbox" />
            Inspect tyre tread depth and wear
          </label>
        </div>
      </li>
      ...
      <li>
        <div class="check-item">
          <label class="resp-company">
            <input type="checkbox" />
            Test front and rear brake operation
          </label>
        </div>
      </li>
  ...
  <div class="responsibility-guide">
