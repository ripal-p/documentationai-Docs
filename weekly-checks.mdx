---
title: Weekly checks
description: Complete these simple weekly checks to keep your rented scooter safe, reliable, and compliant with your rental agreement.
---
<ExpandableGroup>
...
<form>
  ...
  <fieldset>
    ...
    <ul style="list-style:none;padding:0;margin:0;">
      <li>
        <div>
          <label style="display:flex;flex-direction:row;justify-content:start;gap:1rem;align-items:center;">
            <input type="checkbox" />
      ...
      <li>
        <div>
          <label style="display:flex;flex-direction:row;justify-content:start;gap:1rem;align-items:center;">
            <input type="checkbox" />
            Inspect chain or belt for wear or slack
          </label>
        </div>
      </li>
